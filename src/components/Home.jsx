    ...
    render() {
        return (
            ...
            <div className="d-grid gap-3">  
                <a href="farmerlogin" className="btn btn-success btn-rounded" role="button" aria-pressed="true">FARMER</a>
                <a href="displayitem" className="btn btn-success btn-rounded" role="button" aria-pressed="true">BUYER</a>
            </div>
                <br/><br/>
